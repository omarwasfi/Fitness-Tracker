...
{
	public class GetGroupRoomsByPersonIdQueryHandler : IRequestHandler<GetGroupRoomsByPersonIdQuery, List<RoomDataModel>>
	{
        private readonly CurrentStateDBContext _currentStateDBContext;
        private readonly IMediator _mediator;


        public GetGroupRoomsByPersonIdQueryHandler(CurrentStateDBContext currentStateDBContext, IMediator mediator)
		{
            this._currentStateDBContext = currentStateDBContext;
            this._mediator = mediator;
		}

        public async Task<List<RoomDataModel>> Handle(GetGroupRoomsByPersonIdQuery request, CancellationToken cancellationToken)
        {
